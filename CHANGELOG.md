...
## v2.0.0
- 19/12/09 feat(all): create folder by step for CRUD API
- 19/12/09 feat(cli): update urfave cli and manage signal stop
           feat(db): update all dependencies, migrate to official mongodb and migrate
           chore(ptr): fix pointer test
           chore(all): merge go-100 and go-200 schools
...
- 16/12/20 chore(all): refactor from handsongo to todolist (OFU)
